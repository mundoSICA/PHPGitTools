<?php
/**
 * Imprime en la terminal el texto con determinado color.
 *
 * PHP 5
 *
 ...
 * @link          https://secure.wikimedia.org/wikipedia/en/wiki/ANSI_escape_code
 ...
 * See CosoleOutput::styles() to learn more about defining your own styles.  Nested styles are not supported
 * at this time.
 *
...
/**
 * The current output type. Manipulated with CosoleOutput::outputAs();
 *
 * @var integer.
 */
 ...
 * You can modify these styles with CosoleOutput::styles()
 *
 * @var array
 */
...
$colors = Array('error'=>'Error messages',
    'warning' =>  'Warning messages.',
    'info' => 'Informational messages.',
    'comment'  => 'Additional text.',
    'question' => 'Magenta text used');
foreach( $colors as $color=>$description )
    $c->write("<{$color}>{$description}:</{$color}>\n");
